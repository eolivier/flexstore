...
class DeprecatedCreateUserUseCase(private val userRepository: UserRepository) {
    ...
    fun perform(newUser: User) {
        ...
        // Use case
        val createUserDeprecatedUseCase = DeprecatedUseCase(
        ...
        // Run use case
        createUserDeprecatedUseCase.run(newUser)
    }
}